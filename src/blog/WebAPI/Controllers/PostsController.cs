...
public class PostsController : BaseController
{
    ...
    [HttpDelete("{id}")]
    public async Task<ActionResult<DeletedPostResponse>> Delete([FromRoute] Guid id)
    {
    ...
    [HttpGet("{id}")]
    public async Task<ActionResult<GetByIdPostResponse>> GetById([FromRoute] Guid id)
    {
    ...
    [HttpGet]
    public async Task<ActionResult<GetListResponse<GetListPostListItemDto>>> GetList([FromQuery] PageRequest pageRequest)
    {
